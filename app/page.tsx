...
export default function Home() {
  ...
  const generateRandomNames = () => {
    const firstNames = [
      ...
      "Lucas", "Harper", "Henry", "Evelyn", "Alex", "Luna", "Jack", "Ella",
      "Daniel", "Chloe", "Matthew", "Grace", "Jackson", "Zoe", "David",
      "Lily", "Leo", "Aria", "Ryan", "Hazel", "Nathan", "Ellie", "Adam",
      "Sofia", "Owen", "Avery", "Luke", "Madison", "Gabriel", "Scarlett",
      "Anthony", "Abigail", "Isaac", "Emily", "Dylan", "Mila", "Julian",
      "Sam", "Max", "Victoria", "Felix", "Maya", "Oscar", "Aurora",
      "Theo", "Penelope", "Charlie", "Riley", "Jake", "Nora", "Finn"
    ];
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl w-full pointer-events-auto">
            ...
            <p className="text-gray-600 mb-6">
              Enter comma-separated names for the spinning wheel (e.g., Alice, Bob, Charlie)<br />
              <span className="text-sm text-gray-500">Leave empty for random names</span>
            </p>
            <textarea
              value={inputValue}
